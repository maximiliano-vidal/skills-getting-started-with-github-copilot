...
activities = {
    ...
    "Basketball Team": {
        "description": "Train and compete in varsity basketball",
        "schedule": "Tuesdays and Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["marcus@mergington.edu", "chris@mergington.edu"]
    },
    "Soccer Team": {
        "description": "Join the competitive soccer team and develop athletic skills",
    ...
    "Music Band": {
        "description": "Learn and perform musical instruments in the school band",
